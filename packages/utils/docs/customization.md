...
```scss
@include .k-cursor-pointer();
```

#### Source

```scss
// Location https://github.com/telerik/kendo-themes/blob/develop/packages//scss/interactivity/_cursor.scss#L22-L28
@mixin .k-cursor-pointer() {
...
This is equivalent to `align-items: selft-start;`. The items are packed flush to the edge of the alignment container's start side of the item, in the appropriate axis.
...
This is equivalent to `align-items: selft-end;`. The items are packed flush to the edge of the alignment container's end side of the item, in the appropriate axis.
...
This is equivalent to `padding: padding-box;`. The background extends to the outside edge of the border (but underneath the border in z-ordering).
...
This is equivalent to `content: content-box;`. The background extends to the outside edge of the border (but underneath the border in z-ordering).
...
This is equivalent to `text: text;`. The background extends to the outside edge of the border (but underneath the border in z-ordering).
...
This is equivalent to `height: 100vh;`. Specifies 0.25rem height of an element.
...
/// @name .k-place-items-selft-start
/// @group place-items
/// @contextType css
