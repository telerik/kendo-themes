...
<tr>
    ...
    <td><ul><li>sm: "padding-x":"var(--kendo-spacing-0\\.5)","padding-y":"var(--kendo-spacing-0\\.5)","line-size":"calc(100% - 2 * var(--kendo-spacing-0\\.5))"</li><li>md: "padding-x":"var(--kendo-spacing-1)","padding-y":"var(--kendo-spacing-1)","line-size":"calc(100% - 2 * var(--kendo-spacing-1))"</li><li>lg: "padding-x":"var(--kendo-spacing-1\\.5)","padding-y":"var(--kendo-spacing-1\\.5)","line-size":"calc(100% - 2 * var(--kendo-spacing-1\\.5))"</li></ul></td>
</tr>
<tr>
