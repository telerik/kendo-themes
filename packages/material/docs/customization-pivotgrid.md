...
<tr>
    ...
    <td>String</td>
    <td><code>color-mix(in srgb, k-color(on-app-surface) 25%, transparent)</code></td>
    <td><code>color-mix(in srgb, var(--kendo-color-on-app-surface) 25%, transparent)</code></td>
</tr>
<tr>
