...
<tr>
    ...
    <td><ul><li>sm: "link-padding-x":"var(--kendo-spacing-3)","link-padding-y":"var(--kendo-spacing-1\\.5)","icon-link-padding-x":"var(--kendo-spacing-2)","icon-link-padding-y":"var(--kendo-spacing-2)","font-size":"var(--kendo-font-size)","line-height":"var(--kendo-line-height)"</li><li>md: "link-padding-x":"var(--kendo-spacing-3)","link-padding-y":"var(--kendo-spacing-2\\.5)","icon-link-padding-x":"var(--kendo-spacing-3)","icon-link-padding-y":"var(--kendo-spacing-3)","font-size":"var(--kendo-font-size)","line-height":"var(--kendo-line-height)"</li><li>lg: "link-padding-x":"var(--kendo-spacing-3)","link-padding-y":"var(--kendo-spacing-3\\.5)","icon-link-padding-x":"var(--kendo-spacing-4)","icon-link-padding-y":"var(--kendo-spacing-4)","font-size":"var(--kendo-font-size)","line-height":"var(--kendo-line-height)"</li></ul></td>
</tr>
<tr>
