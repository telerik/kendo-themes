...
slug: variables_kendothemematerial_color-gradient
position: 9
---
...
<tr>
    ...
    <td><ul><li>sm: "width":"278px","vertical-slider-height":"212px","rectangle-height":"212px","input-width":"46px","gap":"var(--kendo-spacing-2\\.5)","canvas-gap":"var(--kendo-spacing-2\\.5)","padding-x":"var(--kendo-spacing-3)","padding-y":"var(--kendo-spacing-3)"</li><li>md: "width":"294px","vertical-slider-height":"224px","rectangle-height":"224px","input-width":"50px","gap":"var(--kendo-spacing-3)","canvas-gap":"var(--kendo-spacing-3)","padding-x":"var(--kendo-spacing-3)","padding-y":"var(--kendo-spacing-3)"</li><li>lg: "width":"364px","vertical-slider-height":"270px","rectangle-height":"270px","input-width":"62px","gap":"var(--kendo-spacing-4\\.5)","canvas-gap":"var(--kendo-spacing-4\\.5)","padding-x":"var(--kendo-spacing-4\\.5)","padding-y":"var(--kendo-spacing-4\\.5)"</li></ul></td>
</tr>
<tr>
