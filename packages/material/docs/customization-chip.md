...
<tr>
    ...
    <td><ul><li>sm: "padding-x":"var(--kendo-spacing-4)","padding-y":"calc(var(--kendo-spacing-1\\.5) / 2)","font-size":"var(--kendo-font-size)","line-height":"var(--kendo-line-height)"</li><li>md: "padding-x":"var(--kendo-spacing-4)","padding-y":"calc(var(--kendo-spacing-2\\.5) / 2)","font-size":"var(--kendo-font-size)","line-height":"var(--kendo-line-height)"</li><li>lg: "padding-x":"var(--kendo-spacing-4)","padding-y":"calc(var(--kendo-spacing-3\\.5) / 2)","font-size":"var(--kendo-font-size)","line-height":"var(--kendo-line-height)"</li></ul></td>
</tr>
<tr>
