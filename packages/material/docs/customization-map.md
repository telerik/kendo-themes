...
<tr>
    ...
    <td>Calculation</td>
    <td><code>calc( #{$kendo-icon-size} * 3 + #{$kendo-map-navigator-padding} * 2 )</code></td>
...
<tr>
    ...
    <td><code>calc(var(--kendo-font-size) * 0.75)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>color-mix(in srgb, var(--kendo-color-app-surface) 80%, transparent)</code></td>
</tr>
<tr>
