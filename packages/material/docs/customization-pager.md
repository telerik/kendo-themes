...
<tr>
    ...
    <td><ul><li>sm: "padding-x":"var(--kendo-spacing-1)","padding-y":"var(--kendo-spacing-1)","item-group-spacing":"var(--kendo-spacing-1\\.5)","item-min-width":"calc(var(--kendo-line-height) * 1em + calc(var(--kendo-spacing-3\\.5) / 2) * 2 + 1px * 2)"</li><li>md: "padding-x":"var(--kendo-spacing-2)","padding-y":"var(--kendo-spacing-2)","item-group-spacing":"var(--kendo-spacing-2)","item-min-width":"calc(var(--kendo-line-height) * 1em + calc(var(--kendo-spacing-4\\.5) / 2) * 2 + 1px * 2)"</li><li>lg: "padding-x":"var(--kendo-spacing-2\\.5)","padding-y":"var(--kendo-spacing-2\\.5)","item-group-spacing":"var(--kendo-spacing-2\\.5)","item-min-width":"calc(var(--kendo-line-height) * 1em + calc(var(--kendo-spacing-5\\.5) / 2) * 2 + 1px * 2)"</li></ul></td>
</tr>
<tr>
