...
slug: variables_kendothemematerial_spreadsheet
position: 9
---
...
<tr>
    ...
    <td>String</td>
    <td><code>color-mix(in srgb, k-color(secondary-emphasis) 50%, transparent)</code></td>
    <td><code>color-mix(in srgb, var(--kendo-color-secondary-emphasis, #B6AEC6) 50%, transparent)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>(inset 0 0 0 1px var(--kendo-color-primary, #65558F))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>color-mix(in srgb, var(--kendo-color-app-surface, #FEFBFF) 50%, transparent)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>color-mix(in srgb, var(--kendo-color-secondary, #E8DEF8) 25%, transparent)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>Calculation</td>
    <td><code>calc( #{$kendo-icon-size} + k-spacing(2) )</code></td>
    <td><code>calc(16px + var(--kendo-spacing-2, 0.5rem))</code></td>
</tr>
<tr>
    <td colspan="4" class="theme-variables-description-container"><div><b>Description</b><div class="theme-variables-description">The horizontal padding of the Spreadsheet.</div></div>
    </td>
</tr>
<tr>
...
<tr>
    <td colspan="4" class="theme-variables-description-container"><div><b>Description</b><div class="theme-variables-description">The margin of the Spreadsheet icon.</div></div>
    </td>
</tr>
</tbody>
</table>
