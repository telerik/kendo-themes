...
<tr>
    ...
    <td></td>
    <td>map-merge((base: $base-bg), $theme-colors )</td>
    <td>map-merge((base: $base-bg), $theme-colors )</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>escape-svg( url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path fill='none' stroke='#{$kendo-checkbox-checked-text}' stroke-width='3' d='M4.1,12.7 9,17.6 20.3,6.3'/></svg>") )</td>
    <td>escape-svg( url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path fill='none' stroke='#{$kendo-checkbox-checked-text}' stroke-width='3' d='M4.1,12.7 9,17.6 20.3,6.3'/></svg>") )</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>if( $dark-theme, $white, $kendo-button-text )</td>
    <td>if( $dark-theme, $white, $kendo-button-text )</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>0px 3px 5px -1px rgba(0, 0, 0, .2), 0px 6px 10px rgba(0, 0, 0, .14), 0px 1px 18px rgba(0, 0, 0, .12)</td>
    <td>0px 3px 5px -1px rgba(0, 0, 0, .2), 0px 6px 10px rgba(0, 0, 0, .14), 0px 1px 18px rgba(0, 0, 0, .12)</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>0px 3px 5px -1px try-tint(rgba(0, 0, 0, .2), .5), 0px 6px 10px try-tint(rgba(0, 0, 0, .14), .5), 0px 1px 18px try-tint(rgba(0, 0, 0, .12), .5)</td>
    <td>0px 3px 5px -1px try-tint(rgba(0, 0, 0, .2), .5), 0px 6px 10px try-tint(rgba(0, 0, 0, .14), .5), 0px 1px 18px try-tint(rgba(0, 0, 0, .12), .5)</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>0px 5px 5px -3px rgba(0, 0, 0, .2), 0px 8px 10px 1px rgba(0, 0, 0, .14), 0px 3px 14px 2px rgba(0, 0, 0, .12)</td>
    <td>0px 5px 5px -3px rgba(0, 0, 0, .2), 0px 8px 10px 1px rgba(0, 0, 0, .14), 0px 3px 14px 2px rgba(0, 0, 0, .12)</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>calc( #{map-get( $spacing, 4 )} + #{$kendo-radio-border-width} )</td>
    <td>calc( #{map-get( $spacing, 4 )} + #{$kendo-radio-border-width} )</td>
</tr>
<tr>
    <td colspan="4" class="theme-variables-description-container"><div><b>Description</b><div class="theme-variables-description">Line height of radio button.</div></div>
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>(
    sm: ( font-size: null, track-width: 20px, track-height:  8px, thumb-width: 12px, thumb-height: 12px, thumb-offset: -2px, label-offset: 0px ),
    ...
    lg: ( font-size: null, track-width: 44px, track-height:  20px, thumb-width: 28px, thumb-height: 28px, thumb-offset: -4px, label-offset: 0px )
)</td>
    <td>(
    sm: ( font-size: null, track-width: 20px, track-height:  8px, thumb-width: 12px, thumb-height: 12px, thumb-offset: -2px, label-offset: 0px ),
    md: ( font-size: null, track-width: 32px, track-height:  14px, thumb-width: 20px, thumb-height: 20px, thumb-offset: -3px, label-offset: 0px ),
...
<tr>
    ...
    <td></td>
    <td>rgba( if( $dark-theme, $white, $black ), .38 )</td>
    <td>rgba( if( $dark-theme, $white, $black ), .38 )</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>if( $dark-theme, $black, $white )</td>
    <td>if( $dark-theme, $black, $white )</td>
</tr>
<tr>
