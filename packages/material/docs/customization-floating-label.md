...
<tr>
    ...
    <td><code>calc(var(--kendo-line-height-lg) * var(--kendo-font-size-lg))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>calc(calc(var(--kendo-line-height-lg) * var(--kendo-font-size-lg)) + 1px + calc(var(--kendo-spacing-1\.5) + var(--kendo-spacing-1px)))</code></td>
</tr>
<tr>
