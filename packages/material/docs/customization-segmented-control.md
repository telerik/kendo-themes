...
<tr>
    ...
    <td><code>color-mix(in srgb, var(--kendo-color-surface), currentColor 8%)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>color-mix(in srgb, var(--kendo-color-base-hover), currentColor 4%)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><ul><li>sm: "font-size":"var(--kendo-font-size)","line-height":"var(--kendo-line-height)","button-padding-x":"var(--kendo-spacing-3)","button-padding-y":"var(--kendo-spacing-2)","button-gap":"var(--kendo-spacing-1\\.5)"</li><li>md: "font-size":"var(--kendo-font-size)","line-height":"var(--kendo-line-height)","button-padding-x":"var(--kendo-spacing-3)","button-padding-y":"var(--kendo-spacing-2\\.5)","button-gap":"var(--kendo-spacing-1\\.5)"</li><li>lg: "font-size":"var(--kendo-font-size-lg)","line-height":"var(--kendo-line-height-lg)","button-padding-x":"var(--kendo-spacing-3)","button-padding-y":"var(--kendo-spacing-2\\.5)","button-gap":"var(--kendo-spacing-2)"</li></ul></td>
</tr>
<tr>
