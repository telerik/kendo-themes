...
> The [`Inputs`]({% slug overview_inputs %}) and [`DropDowns`]({% slug overview_dropdowns %}) components are compatible with the `Material Design Guidelines`, providing [Floating labels](https://material.io/guidelines/components/text-fields.html#text-fields-layout) functionality out of the box.
{% endplatform_content %}
