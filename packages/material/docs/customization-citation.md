...
slug: variables_kendothemematerial_citation
position: 9
---
...
<tbody>
    ...
    <td>List</td>
    <td><code>0 k-spacing(4) k-spacing(4) k-spacing(4)</code></td>
    <td><code>(0 var(--kendo-spacing-4) var(--kendo-spacing-4) var(--kendo-spacing-4))</code></td>
</tr>
<tr>
