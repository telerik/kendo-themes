...
slug: variables_kendothemematerial_tile-layout
position: 9
---
...
<tr>
    ...
    <td>String</td>
    <td><code>color-mix(in srgb, k-color(surface-alt) .2, transparent )</code></td>
    <td><code>color-mix(in srgb, var(--kendo-color-surface-alt, #ffffff) 0.2, transparent)</code></td>
</tr>
<tr>
