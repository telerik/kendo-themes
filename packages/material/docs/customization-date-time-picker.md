...
<tr>
    ...
    <td><ul><li>sm: "width":"calc(40px * 8 + var(--kendo-spacing-1) * 2)"</li><li>md: "width":"calc(48px * 8 + var(--kendo-spacing-1) * 2)"</li><li>lg: "width":"calc(56px * 8 + var(--kendo-spacing-1) * 2)"</li></ul></td>
</tr>
<tr>
