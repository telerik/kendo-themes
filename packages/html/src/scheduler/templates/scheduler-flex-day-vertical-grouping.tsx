...
export const SchedulerFlexDayVerticalGrouping = ({ style, today = false, ...props }: any) => (
    <Scheduler
        style={style}
        layout="flex"
        view="day"
        ...
        children={
            <>
                ...
                <SchedulerBody as="div">
                    ...
                    <SchedulerEvent style={{ top: "39px", left: "269px", height: "149px", width: "345px" }} title="Event 1 Title" time="8:00 AM - 10:00 AM" />
                    <SchedulerEvent style={{ top: "39px", left: "618px", height: "194px", width: "342px" }} title="Event 2 Title" time="8:00 AM - 10:30 AM" />
                </SchedulerBody>
            </>
        }
        {...props}
...
/** @deprecated Use `SchedulerFlexDayVerticalGrouping` instead. */
export const SchedulerFlexVerticalGrouping = SchedulerFlexDayVerticalGrouping;
