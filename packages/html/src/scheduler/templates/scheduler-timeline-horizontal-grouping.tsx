...
export const SchedulerTimelineHorizontalGrouping = ({ style, ...props }: any) => (
    <Scheduler
        style={style}
        layout="table"
        view="timeline"
        ...
        children={
            <tbody>
                <SchedulerHead as="tr">
                    ...
                    <td>
                        <SchedulerHeader>
                            <SchedulerTable style={{ width: "990%" }}>
                                <tbody>
                                    <tr>
                                        <SchedulerCell as="th" cellType={[ "slot", "group" ]} colspan={22}>Meeting Room 101</SchedulerCell>
                                        <SchedulerCell as="th" cellType={[ "slot", "group" ]} colspan={22}>Meeting Room 201</SchedulerCell>
                                    </tr>
                                    <tr className="k-scheduler-date-group">
                                        <SchedulerCell cellType={[ "slot" ]} as="th" colspan={22} text="June 13" />
                                        <SchedulerCell cellType={[ "slot" ]} as="th" colspan={22} text="June 13" />
                                    </tr>
                                    <tr>
