                ...
                <div className="k-scheduler-toolbar k-toolbar">
                    <div className="k-toolbar-group">
                        ...
                        <a className="k-nav-current" href="#">
                            ...
                            <span className="k-sm-date-format">June 2013</span>
                            <span className="k-lg-date-format">June 2013</span>
                        </a>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <Button className="k-more-events" icon="more-horizontal" style={{ width: "162px", left: "327px", top: "177px" }} ></Button>
                                            </td>
                                            <td>
                                                <span className="k-link k-nav-day">05</span>
                                                <Button className="k-more-events" icon="more-horizontal" style={{ width: "162px", left: "490px", top: "177px" }} ></Button>
                                            </td>
                                            <td>
