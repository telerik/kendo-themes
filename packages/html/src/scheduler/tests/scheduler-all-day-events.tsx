                ...
                <td>
                  <SchedulerHeader style={{ paddingRight: "16px" }}>
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      <SchedulerEvent continuationLeft endTime="9:00 AM" resizable="horizontal" style={{ top: "0px", left: "0%", width: "260px", height: "25px" }} title="From Last Week Event" />
                      <SchedulerEvent resizable="horizontal" style={{ top: "0px", left: "57.143%", width: "130px", height: "25px" }} title="All Day Event" />
                      <SchedulerEvent startTime="8:00 AM" endTime="5:00 PM" resizable="horizontal" style={{ top: "28px", left: "14.286%", width: "260px", height: "25px" }} title="Multi Day Event Long Event" />
                      <SchedulerEvent startTime="9:00 AM" continuationRight resizable="horizontal" style={{ top: "28px", left: "57%", width: "43%", height: "25px" }} title="To Next Week Event" />
                      <SchedulerEvent continuationLeft continuationRight resizable="horizontal" style={{ top: "56px", left: "0%", width: "100%", height: "25px" }} title="Multi Week Event" />
                    </div>
                  </SchedulerHeader>
                </td>
              </SchedulerHead>
