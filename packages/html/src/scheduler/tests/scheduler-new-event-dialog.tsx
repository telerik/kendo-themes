            ...
            <FormField
              ...
              editor={
                <div className="k-scheduler-datetime-section">
                  ...
                  <div className="k-scheduler-edit-form-row">
                    <Button className="k-scheduler-recurrence-button" fillMode="flat" icon="arrow-rotate-cw" themeColor="primary" selected togglable aria-describedby="recurrence-summary-short">
                      Edit recurrence
                    </Button>
                    <FormHint id="recurrence-summary-short" className="k-scheduler-recurrence-summary" title="Repeats every 2 week(s) on Monday, ending after 6 occurrence(s).">
            ...
            <FormField
              ...
              editor={
                <div className="k-scheduler-datetime-section">
                  ...
                  <div className="k-scheduler-edit-form-row">
                    <Button className="k-scheduler-recurrence-button" fillMode="flat" icon="arrow-rotate-cw" themeColor="primary" selected togglable aria-describedby="recurrence-summary-long">
                      Edit recurrence
                    </Button>
                    <FormHint
                      id="recurrence-summary-long"
