...
export default () => (
  <>
    ...
    <div id="test-area" className="k-d-grid k-grid-cols-1">
      ...
      <section>
        <MenuNormal popup={<></>}>
          <MenuItem icon="folder" text="Normal" showArrow arrowIconName="chevron-down"></MenuItem>
          ...
          <MenuItem icon="folder" text="Disabled" disabled showArrow arrowIconName="chevron-down"></MenuItem>
        </MenuNormal>
      </section>
      <span>Vertical Menu</span>
      <section>
        <MenuNormal orientation="vertical" popup={<></>}>
          <MenuItem icon="folder" text="Normal" showArrow arrowIconName="chevron-right"></MenuItem>
          ...
          <MenuItem icon="folder" text="Disabled" disabled showArrow arrowIconName="chevron-right"></MenuItem>
        </MenuNormal>
      </section>
      ...
      <section>
        <Popup className="k-menu-popup">
          <MenuList>
            <MenuListItem icon="folder" text="Normal" showArrow></MenuListItem>
            ...
            <MenuListItem icon="folder" text="Disabled" disabled showArrow></MenuListItem>
          </MenuList>
        </Popup>
      </section>
    </div>
