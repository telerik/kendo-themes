    ...
    <div id="test-area" className="k-d-grid">
      ...
      {Avatar.options.themeColor.map((themeColor) => (
        <>
          ...
          <AvatarImage fillMode="outline" themeColor={themeColor} border>
            <img src="/packages/html/assets/avatar.jpg" />
          </AvatarImage>

          <AvatarImage fillMode="outline" type="image" themeColor={themeColor} border></AvatarImage>

          <AvatarIcon fillMode="outline" themeColor={themeColor} border>
            <Icon icon="x" />
          </AvatarIcon>

          <AvatarText fillMode="outline" themeColor={themeColor} border>JO</AvatarText>
        </>
      ))}
    </div>
  </>
