    ...
    <>
        ...
        <div id="test-area" className="k-d-grid">
            ...
            <section className="k-container k-gap-4">
                <div className="k-row">
                    <div className="k-col">k-col</div>
                    <div className="k-col-size-66-6">k-col-size-66-6</div>
                    <div className="k-col">k-col</div>
                </div>

                <div className="k-row">
                    <div className="k-col">k-col</div>
                    <div className="k-col-size-50">k-col-size-50</div>
                    <div className="k-col">k-col</div>
                </div>
            </section>
            ...
            <section className="k-container k-gap-4">
                <div className="k-row">
                    <div className="k-col-sm-size-75">k-col-sm-75</div>
                    <div className="k-col-sm-size-25">k-col-sm-25</div>
                </div>

                <div className="k-row">
                    <div className="k-col-sm">k-col-sm</div>
                    <div className="k-col-sm">k-col-sm</div>
                    <div className="k-col-sm">k-col-sm</div>
                </div>
            </section>
            ...
            <section className="k-container k-gap-3 k-gap-md-6">
                <div className="k-row k-gap-3 k-gap-md-6">
                    <div className="k-col">k-col</div>
                    <div className="k-col">k-col</div>
                </div>
