...
root.render(
    <>
        ...
        <div id="test-area" className="k-d-grid k-grid-cols-4">
            ...
            <div>
                <div className="k-animation-container">
                    <div className="k-widget k-popup k-notification k-notification-closable">
                        <div className="k-notification-wrap">
            ...
            <div>
                <div className="k-animation-container">
                    <div className="k-widget k-popup k-notification k-notification-primary">
                        <div className="k-notification-wrap">
            ...
            <div>
                <div className="k-animation-container">
                    <div className="k-widget k-popup k-notification k-notification-secondary">
                        <div className="k-notification-wrap">
            ...
            <div>
                <div className="k-animation-container">
                    <div className="k-widget k-popup k-notification k-notification-tertiary">
                        <div className="k-notification-wrap">
            ...
            <div>
                <div className="k-animation-container">
                    <div className="k-widget k-popup k-notification k-notification-info">
                        <div className="k-notification-wrap">
                            <Icon name="info" />
            ...
            <div>
                <div className="k-animation-container">
                    <div className="k-widget k-popup k-notification k-notification-success">
                        <div className="k-notification-wrap">
                            <Icon name="success" />
            ...
            <div>
                <div className="k-animation-container">
                    <div className="k-widget k-popup k-notification k-notification-warning">
                        <div className="k-notification-wrap">
                            <Icon name="warning" />
            ...
            <div>
                <div className="k-animation-container">
                    <div className="k-widget k-popup k-notification k-notification-error">
                        <div className="k-notification-wrap">
                            <Icon name="error" />
            ...
            <div>
                <div className="k-animation-container">
                    <div className="k-widget k-popup k-notification k-notification-dark">
                        <div className="k-notification-wrap">
            ...
            <div>
                <div className="k-animation-container">
                    <div className="k-widget k-popup k-notification k-notification-light">
                        <div className="k-notification-wrap">
            ...
            <div>
                <div className="k-animation-container">
                    <div className="k-widget k-popup k-notification k-notification-inverse">
                        <div className="k-notification-wrap">
