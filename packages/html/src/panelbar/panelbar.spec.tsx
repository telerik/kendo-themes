...
PanelBar.ariaSpec = {
    ...
    rules: [
        ...
        { selector: '.k-panelbar[aria-activedescendant]', attribute: 'aria-activedescendant', usage: 'Points to the currently focused item in the PanelBar.' },
        { selector: '.k-panelbar-group', attribute: 'role=group', usage: 'The ul element that wraps child nodes.' },
        { selector: '[aria-expanded="false"] > .k-panelbar-group', attribute: 'aria-hidden=true', usage: 'Hides the group element from assistive technologies when its parent is not expanded.' },
