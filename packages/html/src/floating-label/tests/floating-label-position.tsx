        ...
        <div id="test-area" className="k-d-grid k-grid-cols-4">
            ...
            <div>
                <FloatingLabelNormal focus label="Floating label">
                    <TextboxNormal focus size="small" />
                </FloatingLabelNormal>
            </div>
            <div>
                <FloatingLabelNormal focus label="Floating label">
                    <TextboxNormal focus size="small" fillMode="outline" />
                </FloatingLabelNormal>
            </div>
            <div>
                <FloatingLabelNormal focus label="Floating label">
                    <TextboxNormal focus size="small" fillMode="flat" />
                </FloatingLabelNormal>
            </div>
            ...
            <div>
                <FloatingLabelNormal focus label="Floating label">
                    <TextboxNormal focus fillMode="outline" />
                </FloatingLabelNormal>
            </div>
            <div>
                <FloatingLabelNormal focus label="Floating label">
                    <TextboxNormal focus fillMode="flat" />
                </FloatingLabelNormal>
            </div>
            ...
            <div>
                <FloatingLabelNormal focus label="Floating label">
                    <TextboxNormal focus size="large" />
                </FloatingLabelNormal>
            </div>
            <div>
                <FloatingLabelNormal focus label="Floating label">
                    <TextboxNormal focus size="large" fillMode="outline" />
                </FloatingLabelNormal>
            </div>
            <div>
                <FloatingLabelNormal focus label="Floating label">
                    <TextboxNormal focus size="large" fillMode="flat" />
                </FloatingLabelNormal>
            </div>
