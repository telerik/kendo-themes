 ...
 * @aria {aria-label} Describes the navigation button purpose.
...
/**
 * @keyboard {Control/Cmd(Mac) + ArrowRight} Navigates to the next period.
 * @keyboard {Control/Cmd(Mac) + ArrowLeft} Navigates to the previous period.
 *
