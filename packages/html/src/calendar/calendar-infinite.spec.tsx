...
/**
 * @aria {role="grid"} Specifies the role of the Calendar view container.
 * @aria {aria-labelledby} Pointing to the current view label (e.g. March 2022 or 2020-2029).
 * @aria {tabindex="0"} Makes the grid focusable.
 * @aria {role="none"} Inner table has role removed — content belongs to the grid on the view.
 */
