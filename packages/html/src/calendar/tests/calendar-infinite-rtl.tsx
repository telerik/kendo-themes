    ...
    <>
        ...
        <div id="test-area" className="k-d-grid k-grid-cols-2">
            ...
            <section>
                ...
                <CalendarInfiniteNormal dir="rtl" />
            </section>

            <section>
                <div>infinite calendar month without navigation bar</div>
                <CalendarInfiniteNormal dir="rtl" showNavigation={false} />
            </section>

            <section>
                <div>infinite calendar - week number column</div>
                <CalendarInfiniteWeekNumber dir="rtl" />
            </section>

            <section>
                <div>infinite calendar year</div>
                <CalendarInfiniteYear dir="rtl" />
            </section>

            <section>
                <div>infinite calendar decade</div>
                <CalendarInfiniteDecade dir="rtl" />
            </section>

            <section>
                <div>infinite calendar century</div>
                <CalendarInfiniteCentury dir="rtl" />
            </section>
