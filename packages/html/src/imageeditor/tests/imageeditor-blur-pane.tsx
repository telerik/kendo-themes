    ...
    <>
        <div id="test-area" className="k-d-grid k-grid-cols-1">
            ...
            <ImageEditorBlur contentHeight="482px" shape="rectangular" intensity={16}>
                <canvas width="494" height="307" style={{ backgroundImage: "url('/packages/html/assets/sofia.jpg')", backgroundSize: "cover", filter: "blur(8px)" }}></canvas>
            ...
            <ImageEditorBlur contentHeight="482px" shape="elliptical" intensity={18}>
                ...
                <canvas width="494" height="307" style={{ position: "absolute", insetBlockStart: 0, insetInlineStart: 0, backgroundImage: "url('/packages/html/assets/sofia.jpg')", backgroundSize: "cover", filter: "blur(8px)", clipPath: "ellipse(160px 98.5px at center)" }}></canvas>
                <div className="k-imageeditor-crop-overlay">
