...
export const RatingItem = (
    ...
    switch (iconType) {
        case "split":
            ...
            break;
        case "outline":
            itemContent = <Icon icon="star" variant="outline" size="xlarge" />;
            break;
        case "solid":
            itemContent = <Icon icon="star" variant="solid" size="xlarge" />;
            break;
        default:
            return undefined;
    }
