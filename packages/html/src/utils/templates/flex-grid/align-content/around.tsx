export function AlignContentAroundUtils() {

    return (
        <div className="k-align-content-around k-d-grid k-grid-cols-2 k-gap-6 k-w-full k-h-full k-text-center k-text-white">
