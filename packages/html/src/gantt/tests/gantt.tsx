        ...
        <div id="test-area">
            ...
            <div id="gantt" className="k-widget k-gantt">
                ...
                <div className="k-gantt-content">
                    <div className="k-splitter k-splitter-flex k-splitter-horizontal">
                        <div className="k-gantt-treelist k-gantt-treelist-scrollable k-pane">
                        ...
                        <div className="k-gantt-timeline-pane k-pane">
