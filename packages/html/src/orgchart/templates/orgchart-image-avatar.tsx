    ...
    <Orgchart
        children={
            <OrgchartGroup
                ...
                nodes={
                    <>
                        <OrgchartNode title="Card Title" subtitle="Card, Subtitle" details={details} avatar="https://example.com/avatar.png" avatarType="image" avatarAlt="John Doe" color="#0275d8" ariaLevel={1} menuButton focus></OrgchartNode>
