        ...
        <div id="test-area" className="k-d-grid k-grid-cols-2">
            ...
            <section className="k-colspan-all k-col-span-full">
                <ToolbarResizable>
                    ...
                    <ToolbarSeparator className="k-toolbar-button-separator" />
                    <Button icon="more-vertical" className="k-toolbar-overflow-button" fillMode="flat" hover></Button>
                </ToolbarResizable>
            </section>
            <section className="k-colspan-all k-col-span-full">
                <ToolbarResizable>
                    ...
                    <ToolbarSeparator className="k-toolbar-button-separator" />
                    <Button icon="more-vertical" className="k-toolbar-overflow-button" fillMode="flat" focus></Button>
                </ToolbarResizable>
            </section>
            <section className="k-colspan-all k-col-span-full">
                <ToolbarResizable>
                    ...
                    <ToolbarSeparator className="k-toolbar-button-separator" />
                    <Button icon="more-vertical" className="k-toolbar-overflow-button" fillMode="flat" active></Button>
                </ToolbarResizable>
            </section>
            ...
            <section className="k-colspan-all k-col-span-full">
                <ToolbarResizable>
                    ...
                    <ToolbarSeparator className="k-toolbar-button-separator" />
                    <Button icon="more-vertical" className="k-toolbar-overflow-button" fillMode="flat" disabled focus></Button>
                </ToolbarResizable>
            </section>
