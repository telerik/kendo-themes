...
| --- | --- |
| `role="tree"` | The root list element of the treeview. |
| `role="group"` | The ul element that wraps child nodes. |
...
| Attribute | Description |
| --- | --- |
| `role="treeitem"` | The li element rendered for a tree node. |
| `aria-expanded="true"|\"false"` | Announces the expanded state of the node. |
| `aria-checked="true"|\"false"` | Announces the checked state of the node when checkboxes are enabled. |
