...
| `.k-gantt-timeline .k-task` | `aria-level` | Specifies the nesting level of the task. |
| `.k-gantt-timeline .k-task` | `aria-describedby` | References the tooltip providing task details (when visible). |
