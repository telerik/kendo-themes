...
slug: variables_kendothemebootstrap_input
position: 9
---
...
<tr>
    ...
    <td><code>(0 0 0 0.25rem color-mix(in srgb, var(--kendo-color-error) 25%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><ul><li>sm: "padding-x":"var(--kendo-spacing-2)","padding-y":"var(--kendo-spacing-1)","font-size":"var(--kendo-font-size-sm)","line-height":1.4285714285714286,"button-padding-x":"var(--kendo-spacing-1)","button-padding-y":"var(--kendo-spacing-1)"</li><li>md: "padding-x":"var(--kendo-spacing-3)","padding-y":"var(--kendo-spacing-1\\.5)","font-size":"var(--kendo-font-size)","line-height":"var(--kendo-line-height)","button-padding-x":"var(--kendo-spacing-1\\.5)","button-padding-y":"var(--kendo-spacing-1\\.5)"</li><li>lg: "padding-x":"var(--kendo-spacing-4)","padding-y":"var(--kendo-spacing-2)","font-size":"var(--kendo-font-size-lg)","line-height":"var(--kendo-line-height)","button-padding-x":"var(--kendo-spacing-2)","button-padding-y":"var(--kendo-spacing-2)"</li></ul></td>
</tr>
<tr>
