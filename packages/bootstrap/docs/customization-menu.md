...
<tr>
    ...
    <td><code>(inset 0 0 0 3px color-mix(in srgb, var(--kendo-color-on-app-surface) 15%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>color-mix(in srgb, var(--kendo-color-on-app-surface) 70%, transparent)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>calc(var(--kendo-spacing-4) * 2 + 1rem)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>calc(-1 * (calc(var(--kendo-spacing-4) * 2 + 1rem) - var(--kendo-spacing-4) / 2))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><ul><li>sm: "font-size":"var(--kendo-font-size)","line-height":"var(--kendo-line-height)","item-padding-y":"var(--kendo-spacing-1)","item-padding-x":"var(--kendo-spacing-4)","item-padding-end":"calc(var(--kendo-spacing-4) * 2 + 1rem)","item-icon-margin-start":"var(--kendo-spacing-4)","item-icon-margin-end":"calc(-1 * (calc(var(--kendo-spacing-4) * 2 + 1rem) - var(--kendo-spacing-4) / 2))","group-header-padding-x":"var(--kendo-spacing-4)","group-header-padding-y":"var(--kendo-spacing-0)","group-header-font-size":"var(--kendo-font-size-xs)","group-header-line-height":"var(--kendo-line-height)"</li><li>md: "font-size":"var(--kendo-font-size)","line-height":"var(--kendo-line-height)","item-padding-y":"var(--kendo-spacing-1)","item-padding-x":"var(--kendo-spacing-4)","item-padding-end":"calc(var(--kendo-spacing-4) * 2 + 1rem)","item-icon-margin-start":"var(--kendo-spacing-4)","item-icon-margin-end":"calc(-1 * (calc(var(--kendo-spacing-4) * 2 + 1rem) - var(--kendo-spacing-4) / 2))","group-header-padding-x":"var(--kendo-spacing-4)","group-header-padding-y":"var(--kendo-spacing-0\\.5)","group-header-font-size":"var(--kendo-font-size-xs)","group-header-line-height":"var(--kendo-line-height)"</li><li>lg: "font-size":"var(--kendo-font-size-lg)","line-height":"var(--kendo-line-height)","item-padding-y":"var(--kendo-spacing-2)","item-padding-x":"var(--kendo-spacing-4)","item-padding-end":"calc(var(--kendo-spacing-4) * 2 + 1rem)","item-icon-margin-start":"var(--kendo-spacing-4)","item-icon-margin-end":"calc(-1 * (calc(var(--kendo-spacing-4) * 2 + 1rem) - var(--kendo-spacing-4) / 2))","group-header-padding-x":"var(--kendo-spacing-4)","group-header-padding-y":"var(--kendo-spacing-1\\.5)","group-header-font-size":"var(--kendo-font-size-xs)","group-header-line-height":"var(--kendo-line-height)"</li></ul></td>
</tr>
<tr>
