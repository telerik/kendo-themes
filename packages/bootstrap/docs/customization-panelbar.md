...
slug: variables_kendothemebootstrap_panelbar
position: 9
---
...
<tr>
    ...
    <td>String</td>
    <td><code>color-mix(in srgb, $kendo-panelbar-header-text 8%, transparent)</code></td>
    <td><code>color-mix(in srgb, var(--kendo-color-primary-on-surface) 8%, transparent)</code></td>
</tr>
<tr>
