...
slug: variables_kendothemebootstrap_stepper
position: 9
---
...
<tr>
    ...
    <td>String</td>
    <td><code>color-mix(in srgb, k-color(on-app-surface) 65%, transparent)</code></td>
    <td><code>color-mix(in srgb, var(--kendo-color-on-app-surface) 65%, transparent)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>color-mix(in srgb, var(--kendo-color-primary) 60%, transparent)</code></td>
</tr>
<tr>
