...
slug: variables_kendothemebootstrap_color-editor
position: 9
---
...
<tr>
    ...
    <td><ul><li>sm: "min-width":"266px","header-padding-x":"var(--kendo-spacing-4)","header-padding-y":"var(--kendo-spacing-4)","views-padding-x":"var(--kendo-spacing-4)","views-padding-y":"var(--kendo-spacing-4)","preview-gap":"var(--kendo-spacing-1)","preview-width":"32px","preview-height":"10px"</li><li>md: "min-width":"328px","header-padding-x":"var(--kendo-spacing-4)","header-padding-y":"var(--kendo-spacing-4)","views-padding-x":"var(--kendo-spacing-4)","views-padding-y":"var(--kendo-spacing-4)","preview-gap":"var(--kendo-spacing-1)","preview-width":"32px","preview-height":"12px"</li><li>lg: "min-width":"362px","header-padding-x":"var(--kendo-spacing-4\\.5)","header-padding-y":"var(--kendo-spacing-4\\.5)","views-padding-x":"var(--kendo-spacing-4\\.5)","views-padding-y":"var(--kendo-spacing-4\\.5)","preview-gap":"var(--kendo-spacing-1)","preview-width":"32px","preview-height":"12px"</li></ul></td>
</tr>
<tr>
