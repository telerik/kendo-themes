...
slug: variables_kendothemebootstrap_breadcrumb
position: 9
---
...
<tr>
    ...
    <td>String</td>
    <td><code>color-mix(in srgb, k-color(primary-on-surface), black 10%)</code></td>
    <td><code>color-mix(in srgb, var(--kendo-color-primary-on-surface), black 10%)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><ul><li>sm: "link-padding-x":"var(--kendo-spacing-2)","link-padding-y":"var(--kendo-spacing-1\\.5)","icon-link-padding-x":"var(--kendo-spacing-2)","icon-link-padding-y":"var(--kendo-spacing-2)","font-size":"var(--kendo-font-size-sm)","line-height":1.4285714285714286</li><li>md: "link-padding-x":"var(--kendo-spacing-2\\.5)","link-padding-y":"var(--kendo-spacing-2)","icon-link-padding-x":"var(--kendo-spacing-3)","icon-link-padding-y":"var(--kendo-spacing-3)","font-size":"var(--kendo-font-size)","line-height":"var(--kendo-line-height)"</li><li>lg: "link-padding-x":"var(--kendo-spacing-3)","link-padding-y":"var(--kendo-spacing-2\\.5)","icon-link-padding-x":"var(--kendo-spacing-3\\.5)","icon-link-padding-y":"var(--kendo-spacing-3\\.5)","font-size":"var(--kendo-font-size)","line-height":"var(--kendo-line-height)"</li></ul></td>
</tr>
<tr>
