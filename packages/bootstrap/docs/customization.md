...
<td><span class="color-preview" style="background-color: #e4e7eb"></span>
...
`0 0 0 .25rem rgba( $button-border, .5 )`
...
`escape-svg( url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'><path fill='none' stroke='#{$checkbox-checked-text}' stroke-linecap='round' stroke-linejoin='round' stroke-width='3' d='M6 10l3 3l6-6'/></svg>") )`
...
`escape-svg( url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'><path fill='none' stroke='#{$checkbox-indeterminate-text}' stroke-linecap='round' stroke-linejoin='round' stroke-width='3' d='M6 10h8'/></svg>") )`
...
`escape-svg( url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'><circle r='2' fill='#{$radio-checked-text}'/></svg>") )`
...
<tr>
    <td>$switch-container-border-width</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-handle-border-width</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-label-text-transform</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-off-hovered-border</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-off-hovered-gradient</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-off-focused-border</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-off-focused-gradient</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-off-focused-shadow</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-off-handle-border</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-off-handle-gradient</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-off-handle-hovered-bg</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-off-handle-hovered-text</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-off-handle-hovered-border</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-off-handle-hovered-gradient</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-on-hovered-border</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-on-hovered-gradient</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-on-focused-border</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-on-focused-gradient</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-on-focused-shadow</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-on-handle-gradient</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-on-handle-hovered-bg</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-on-handle-hovered-text</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-on-handle-hovered-border</td>
    <td></td>
<td>
...
<tr>
    <td>$switch-on-handle-hovered-gradient</td>
    <td></td>
<td>
...
`inset 0 0 0 2px rgba( $treeview-text, .15 )`
