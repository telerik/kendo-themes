...
<tr>
    ...
    <td><ul><li>sm: "form-rows-spacing":"var(--kendo-spacing-4, 1rem)"</li><li>md: "form-rows-spacing":"var(--kendo-spacing-4, 1rem)"</li><li>lg: "form-rows-spacing":"var(--kendo-spacing-4, 1rem)"</li></ul></td>
</tr>
<tr>
