...
slug: variables_kendothemebootstrap_color-gradient
position: 9
---
...
<tr>
    ...
    <td><ul><li>sm: "width":"266px","vertical-slider-height":"188px","rectangle-height":"188px","input-width":"42px","gap":"var(--kendo-spacing-4)","canvas-gap":"var(--kendo-spacing-3)","padding-x":"var(--kendo-spacing-4)","padding-y":"var(--kendo-spacing-4)"</li><li>md: "width":"328px","vertical-slider-height":"250px","rectangle-height":"250px","input-width":"56px","gap":"var(--kendo-spacing-4)","canvas-gap":"var(--kendo-spacing-3)","padding-x":"var(--kendo-spacing-4)","padding-y":"var(--kendo-spacing-4)"</li><li>lg: "width":"362px","vertical-slider-height":"268px","rectangle-height":"268px","input-width":"62px","gap":"var(--kendo-spacing-4\\.5)","canvas-gap":"var(--kendo-spacing-4\\.5)","padding-x":"var(--kendo-spacing-4\\.5)","padding-y":"var(--kendo-spacing-4\\.5)"</li></ul></td>
</tr>
<tr>
