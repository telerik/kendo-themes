...
slug: variables_kendothemedefault_image-editor
position: 9
---
...
<tr>
    ...
    <td>List</td>
    <td><code>0 0 0 1px k-color(surface), 0 0 0 2px k-color(primary)</code></td>
    <td><code>(0 0 0 1px var(--kendo-color-surface), 0 0 0 2px var(--kendo-color-primary))</code></td>
</tr>
<tr>
