...
slug: variables_kendothememeridian_image-editor
position: 9
---
...
<tr>
    ...
    <td>List</td>
    <td><code>inset 0 0 0 2px k-color(subtle), inset 0 0 0 4px k-color(surface-alt)</code></td>
    <td><code>(inset 0 0 0 2px var(--kendo-color-subtle), inset 0 0 0 4px var(--kendo-color-surface-alt))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>List</td>
    <td><code>inset 0 0 0 2px k-color(secondary-on-surface), inset 0 0 0 4px k-color(surface-alt)</code></td>
    <td><code>(inset 0 0 0 2px var(--kendo-color-secondary-on-surface), inset 0 0 0 4px var(--kendo-color-surface-alt))</code></td>
</tr>
<tr>
