...
slug: variables_kendothememeridian_filter
position: 9
---
...
<tr>
    ...
    <td>List</td>
    <td><code>0 0 0 1px white, 0 0 0 2px k-color(subtle)</code></td>
    <td><code>(0 0 0 1px white, 0 0 0 2px var(--kendo-color-subtle))</code></td>
</tr>
<tr>
