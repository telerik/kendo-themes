...
slug: variables_kendothememeridian_stepper
position: 9
---
...
<tr>
    ...
    <td><code>color-mix(in srgb, var(--kendo-color-on-app-surface) 60%, transparent)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>color-mix(in srgb, k-color(secondary) 60%, transparent)</code></td>
    <td><code>color-mix(in srgb, var(--kendo-color-secondary) 60%, transparent)</code></td>
</tr>
<tr>
