...
slug: variables_kendothememeridian_skeleton
position: 9
---
...
<tr>
    ...
    <td>String</td>
    <td><code>color-mix(in srgb, k-color(subtle) 20%, transparent)</code></td>
    <td><code>color-mix(in srgb, var(--kendo-color-subtle) 20%, transparent)</code></td>
</tr>
<tr>
