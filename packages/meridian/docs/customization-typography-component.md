...
slug: variables_kendothememeridian_typography-component
position: 9
---
...
<tr>
    ...
    <td>Calculation</td>
    <td><code>calc( var( --kendo-font-size ) * 3.25 )</code></td>
    <td><code>calc(var(--kendo-font-size) * 3.25)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>Calculation</td>
    <td><code>calc( var( --kendo-font-size ) * 1.75 )</code></td>
    <td><code>calc(var(--kendo-font-size) * 1.75)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>Calculation</td>
    <td><code>calc( var( --kendo-font-size ) * 1.375 )</code></td>
    <td><code>calc(var(--kendo-font-size) * 1.375)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>Calculation</td>
    <td><code>calc( var( --kendo-font-size ) * 1.125 )</code></td>
    <td><code>calc(var(--kendo-font-size) * 1.125)</code></td>
</tr>
<tr>
