# Kendo UI Meridian Theme

The Kendo UI Meridian Theme is the recommended SCSS-based theme for the Kendo UI components. It provides a modern, accessible visual language designed as the default starting point for new projects.
...
Kendo UI Meridian Theme is available as an npm package.
...
```html
<link rel="stylesheet" href="https://unpkg.com/@progress/kendo-theme-meridian/dist/all.css" />
```
...
For more information on how to implement the Meridian theme in your project, refer to the following articles:

* [Using the Meridian Theme in Angular Projects](https://www.telerik.com/kendo-angular-ui/components/styling/theme-meridian/)
* [Using the Meridian Theme in React Projects](https://www.telerik.com/kendo-react-ui/components/styling/theme-meridian/)
* [Using the Meridian Theme in jQuery Projects](http://docs.telerik.com/kendo-ui/styles-and-layout/sass-themes)

## Customizing

You can customize Kendo UI Meridian Theme both in terms of what gets compiled and how the theme will look.
...
Kendo UI Meridian Theme provides many variables for customization. There are variables that control globally used theme colors like `$primary`, `$secondary`, `$success`, `$error` etc.; variables for all components such as `$component-text`, `$component-bg`; as well as variables for individual components such as `$grid-bg`, `$tabstrip-font-size` and so on.
...
Have a bug or a feature request? Please first search for existing and closed issues. If your problem or idea is not addressed yet, please open a new [bug report](https://github.com/telerik/kendo-themes/issues/new?labels=bug,T:Meridian&template=bug_report.md) or [feature request](https://github.com/telerik/kendo-themes/issues/new?labels=Enhancement,T:Meridian&template=feature_request.md).
