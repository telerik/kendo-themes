...
<tbody>
    ...
    <td><code>var(--kendo-orgchart-spacer, var(--kendo-spacing-6))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-padding-y, var(--kendo-orgchart-spacer, var(--kendo-spacing-6)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-padding-x, var(--kendo-orgchart-padding-y, var(--kendo-orgchart-spacer, var(--kendo-spacing-6))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-orgchart-font-family, var(--kendo-font-family) )</code></td>
    <td><code>var(--kendo-orgchart-font-family, var(--kendo-font-family))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-orgchart-font-size, var(--kendo-font-size) )</code></td>
    <td><code>var(--kendo-orgchart-font-size, var(--kendo-font-size))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-orgchart-line-height, var(--kendo-line-height) )</code></td>
    <td><code>var(--kendo-orgchart-line-height, var(--kendo-line-height))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-bg, var(--kendo-color-surface-alt))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-text, var(--kendo-color-on-app-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-border, color-mix(in srgb, var(--kendo-color-border) 16%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-node-spacing, var(--kendo-orgchart-spacer, var(--kendo-spacing-6)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-group-spacing, var(--kendo-orgchart-spacer, var(--kendo-spacing-6)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-node-group-padding-y, var(--kendo-orgchart-spacer, var(--kendo-spacing-6)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-node-group-padding-x, var(--kendo-orgchart-node-group-padding-y, var(--kendo-orgchart-spacer, var(--kendo-spacing-6))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-node-group-border-radius, var(--kendo-border-radius-md))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-node-group-bg, var(--kendo-color-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-node-group-text, var(--kendo-color-on-app-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-node-group-border, color-mix(in srgb, var(--kendo-color-border) 16%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-node-group-focus-border, var(--kendo-color-border-alt))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-node-group-title-margin-y, var(--kendo-spacing-0))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-orgchart-node-group-title-font-size, var(--kendo-font-size-xl) )</code></td>
    <td><code>var(--kendo-orgchart-node-group-title-font-size, var(--kendo-font-size-xl))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-orgchart-node-group-title-line-height, var(--kendo-line-height) )</code></td>
    <td><code>var(--kendo-orgchart-node-group-title-line-height, var(--kendo-line-height))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-node-group-subtitle-margin-y, calc(var(--kendo-orgchart-spacer, var(--kendo-spacing-6)) - var(--kendo-spacing-1)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-orgchart-node-group-subtitle-font-size, var(--kendo-font-size) )</code></td>
    <td><code>var(--kendo-orgchart-node-group-subtitle-font-size, var(--kendo-font-size))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-node-group-subtitle-text, var(--kendo-color-subtle))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-card-title-margin-y, var(--kendo-spacing-0))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-card-title-font-size, var(--kendo-card-title-font-size, var(--kendo-font-size-md)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-orgchart-card-title-line-height, var(--kendo-line-height) )</code></td>
    <td><code>var(--kendo-orgchart-card-title-line-height, var(--kendo-line-height))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-card-subtitle-margin-y, var(--kendo-spacing-0))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-orgchart-card-subtitle-font-size, var(--kendo-font-size-sm) )</code></td>
    <td><code>var(--kendo-orgchart-card-subtitle-font-size, var(--kendo-font-size-sm))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-orgchart-card-subtitle-line-height, var(--kendo-line-height) )</code></td>
    <td><code>var(--kendo-orgchart-card-subtitle-line-height, var(--kendo-line-height))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-card-body-padding-y, calc(var(--kendo-orgchart-spacer, var(--kendo-spacing-6)) - var(--kendo-spacing-2)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-card-body-padding-x, var(--kendo-orgchart-card-body-padding-y, calc(var(--kendo-orgchart-spacer, var(--kendo-spacing-6)) - var(--kendo-spacing-2))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-card-body-vbox-margin-x, calc(var(--kendo-orgchart-spacer, var(--kendo-spacing-6)) - var(--kendo-spacing-2)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-line-text, color-mix(in srgb, var(--kendo-color-border) 16%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-orgchart-line-v-height, var(--kendo-spacing-6))</code></td>
</tr>
<tr>
