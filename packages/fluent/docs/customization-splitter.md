...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-splitter-font-size, var( --kendo-font-size, initial ) )</code></td>
    <td><code>var(--kendo-splitter-font-size, var(--kendo-font-size, initial))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-splitter-line-height, var( --kendo-line-height, initial ) )</code></td>
    <td><code>var(--kendo-splitter-line-height, var(--kendo-line-height, initial))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-splitter-font-family, var( --kendo-font-family, initial ) )</code></td>
    <td><code>var(--kendo-splitter-font-family, var(--kendo-font-family, initial))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-splitter-bg, var(--kendo-color-surface-alt, #ffffff))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-splitter-text, #{k-color(on-app-surface)} )</code></td>
    <td><code>var(--kendo-splitter-text, var(--kendo-color-on-app-surface, #323130))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-splitter-border, #{color-mix(in srgb, k-color(border) 16%, transparent)} )</code></td>
    <td><code>var(--kendo-splitter-border, color-mix(in srgb, var(--kendo-color-border, #8a8886) 16%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-splitter-splitbar-size, var(--kendo-spacing-3, 0.75rem))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-splitter-drag-handle-length, var(--kendo-spacing-5, 1.25rem))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-splitter-drag-handle-thickness, var(--kendo-spacing-0\.5, 0.125rem))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-splitter-drag-icon-margin, var(--kendo-spacing-2, 0.5rem))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-splitter-collapse-icon-padding-y, var(--kendo-spacing-0\.5, 0.125rem))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-splitbar-bg, #{k-color(surface)} )</code></td>
    <td><code>var(--kendo-splitbar-bg, var(--kendo-color-surface, #faf9f8))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-splitbar-text, #{k-color(on-app-surface)} )</code></td>
    <td><code>var(--kendo-splitbar-text, var(--kendo-color-on-app-surface, #323130))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-splitbar-hover-bg, #{k-color(base-hover)} )</code></td>
    <td><code>var(--kendo-splitbar-hover-bg, var(--kendo-color-base-hover, #f3f2f1))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-splitbar-hover-text, var(--kendo-splitbar-text, var(--kendo-color-on-app-surface, #323130)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-splitbar-selected-bg, var(--kendo-color-primary, #0078d4))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-splitbar-selected-text, #{k-color(surface-alt)} )</code></td>
    <td><code>var(--kendo-splitbar-selected-text, var(--kendo-color-surface-alt, #ffffff))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-splitter-splitbar-static-size, var(--kendo-spacing-0\.5, 0.125rem))</code></td>
</tr>
<tr>
