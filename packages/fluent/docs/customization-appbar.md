...
<tbody>
    ...
    <td>String</td>
    <td><code>var( --kendo-appbar-default-theme-color, light )</code></td>
    <td><code>var(--kendo-appbar-default-theme-color, light)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-appbar-margin-x, var(--kendo-spacing-0, 0px))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-appbar-margin-y, var(--kendo-spacing-0, 0px))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-appbar-padding-x, var(--kendo-spacing-5, 1.25rem))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-appbar-padding-y, var(--kendo-spacing-3\.5, 0.875rem))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-appbar-font-family, var( --kendo-font-family, inherit ) )</code></td>
    <td><code>var(--kendo-appbar-font-family, var(--kendo-font-family, inherit))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-appbar-font-size, var( --kendo-font-size, inherit ) )</code></td>
    <td><code>var(--kendo-appbar-font-size, var(--kendo-font-size, inherit))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-appbar-line-height, var( --kendo-line-height, normal ) )</code></td>
    <td><code>var(--kendo-appbar-line-height, var(--kendo-line-height, normal))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-appbar-spacing, var(--kendo-spacing-2, 0.5rem))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-appbar-text, k-color(on-app-surface) )</code></td>
    <td><code>var(--kendo-appbar-text, var(--kendo-color-on-app-surface, #242424))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-appbar-bg, k-color(surface) )</code></td>
    <td><code>var(--kendo-appbar-bg, var(--kendo-color-surface, #ffffff))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-appbar-border, color-mix(in srgb, k-color(border) 26%, transparent) )</code></td>
    <td><code>var(--kendo-appbar-border, color-mix(in srgb, var(--kendo-color-border, rgba(36, 36, 36, 0.72)) 26%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-color-on-light, #242424)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-color-dark, #242424)</code></td>
</tr>
<tr>
