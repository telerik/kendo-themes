...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-appbar-padding-x, k-spacing(2) )</code></td>
    <td><code>var(--kendo-appbar-padding-x, var(--kendo-spacing-2, 0.5rem))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-appbar-padding-y, k-spacing(2) )</code></td>
    <td><code>var(--kendo-appbar-padding-y, var(--kendo-spacing-2, 0.5rem))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-appbar-text, var(--kendo-color-on-app-surface, #323130))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-appbar-bg, var(--kendo-color-surface, #faf9f8))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-appbar-border, color-mix(in srgb, k-color(border) 16%, transparent) )</code></td>
    <td><code>var(--kendo-appbar-border, color-mix(in srgb, var(--kendo-color-border, #8a8886) 16%, transparent))</code></td>
</tr>
<tr>
