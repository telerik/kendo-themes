...
<tr>
    ...
    <td><code>(2px solid var(--kendo-color-border-alt))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-checkbox-hover-checked-bg, var(--kendo-color-primary-hover))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-checkbox-hover-checked-border, var(--kendo-checkbox-hover-checked-bg, var(--kendo-color-primary-hover)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-checkbox-hover-indeterminate-bg, var(--kendo-checkbox-bg, var(--kendo-color-surface-alt)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-checkbox-hover-indeterminate-text, var(--kendo-color-primary-hover))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-checkbox-hover-indeterminate-border, var(--kendo-color-primary-hover))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-checkbox-disabled-indeterminate-bg, var(--kendo-checkbox-bg, var(--kendo-color-surface-alt)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-checkbox-disabled-indeterminate-text, var(--kendo-checkbox-disabled-text, color-mix(in srgb, var(--kendo-color-on-app-surface) 30%, transparent)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-checkbox-disabled-indeterminate-border, var(--kendo-checkbox-disabled-border, color-mix(in srgb, var(--kendo-color-on-app-surface) 14%, transparent)))</code></td>
</tr>
<tr>
    <td colspan="4" class="theme-variables-description-container"><div><b>Description</b><div class="theme-variables-description">The border color of the disabled and indeterminate CheckBox.</div></div>
    </td>
...
<tr>
    ...
    <td><code>var(--kendo-checkbox-hover-image, url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23323130' stroke-linecap='square' stroke-linejoin='square' stroke-width='2' d='M3,8 l3,3 l7-7'/%3e%3c/svg%3e"))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-checkbox-hover-indeterminate-image, #{ k-escape-svg( url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'><rect x='3' y='3' width='10' height='10' rx='2' fill='#106ebe'/></svg>") )} )</code></td>
    <td><code>var(--kendo-checkbox-hover-indeterminate-image, url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3crect x='3' y='3' width='10' height='10' rx='2' fill='%23106ebe'/%3e%3c/svg%3e"))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-checkbox-disabled-checked-image, #{ k-escape-svg( url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'><path fill='none' stroke='#ffffff' stroke-linecap='square' stroke-linejoin='square' stroke-width='2' d='M3,8 l3,3 l7-7'/></svg>") ) })</code></td>
    <td><code>var(--kendo-checkbox-disabled-checked-image, url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23ffffff' stroke-linecap='square' stroke-linejoin='square' stroke-width='2' d='M3,8 l3,3 l7-7'/%3e%3c/svg%3e"))</code></td>
</tr>
<tr>
    <td colspan="4" class="theme-variables-description-container"><div><b>Description</b><div class="theme-variables-description">The image of the checked CheckBox indicator.</div></div>
    </td>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-checkbox-disabled-indeterminate-image, #{ k-escape-svg( url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'><rect x='3' y='3' width='10' height='10' rx='2' fill='#323130'/></svg>") )} )</code></td>
    <td><code>var(--kendo-checkbox-disabled-indeterminate-image, url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3crect x='3' y='3' width='10' height='10' rx='2' fill='%23323130'/%3e%3c/svg%3e"))</code></td>
</tr>
<tr>
    <td colspan="4" class="theme-variables-description-container"><div><b>Description</b><div class="theme-variables-description">The image of the indeterminate CheckBox indicator.</div></div>
    </td>
