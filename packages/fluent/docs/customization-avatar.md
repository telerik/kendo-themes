...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-avatar-font-family, var(--kendo-font-family) )</code></td>
    <td><code>var(--kendo-avatar-font-family, var(--kendo-font-family))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-avatar-font-size, var(--kendo-font-size) )</code></td>
    <td><code>var(--kendo-avatar-font-size, var(--kendo-font-size))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-avatar-line-height, var(--kendo-line-height) )</code></td>
    <td><code>var(--kendo-avatar-line-height, var(--kendo-line-height))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><ul><li>sm: var(--kendo-spacing-4)</li><li>md: var(--kendo-spacing-8)</li><li>lg: var(--kendo-spacing-16)</li></ul></td>
</tr>
<tr>
