...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-loader-container-panel-border-color, color-mix(in srgb, k-color(border) 16%, transparent) )</code></td>
    <td><code>var(--kendo-loader-container-panel-border-color, color-mix(in srgb, var(--kendo-color-border, #8a8886) 16%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-loader-container-panel-bg, #{k-color(app-surface)} )</code></td>
    <td><code>var(--kendo-loader-container-panel-bg, var(--kendo-color-app-surface, #ffffff))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-loader-sm-container-gap, #{k-spacing(1)} )</code></td>
    <td><code>var(--kendo-loader-sm-container-gap, var(--kendo-spacing-1, 0.25rem))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-loader-lg-container-gap, #{k-spacing(3)} )</code></td>
    <td><code>var(--kendo-loader-lg-container-gap, var(--kendo-spacing-3, 0.75rem))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-loader-sm-container-font-size, var( --kendo-font-size-sm, inherit ) )</code></td>
    <td><code>var(--kendo-loader-sm-container-font-size, var(--kendo-font-size-sm, inherit))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-loader-md-container-font-size, var( --kendo-font-size, inherit ) )</code></td>
    <td><code>var(--kendo-loader-md-container-font-size, var(--kendo-font-size, inherit))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-loader-lg-container-font-size, var( --kendo-font-size-lg, inherit ) )</code></td>
    <td><code>var(--kendo-loader-lg-container-font-size, var(--kendo-font-size-lg, inherit))</code></td>
</tr>
<tr>
