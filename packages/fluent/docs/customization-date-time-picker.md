...
<tr>
    ...
    <td><ul><li>sm: "width":"calc(var(--kendo-calendar-sm-cell-size, 24px) * 8 + var(--kendo-infinite-calendar-view-padding-x, var(--kendo-spacing-3)) * 2)"</li><li>md: "width":"calc(calc(var(--kendo-calendar-cell-size, 32px) * 8) + var(--kendo-infinite-calendar-view-padding-x, var(--kendo-spacing-3)) * 2)"</li><li>lg: "width":"calc(var(--kendo-calendar-lg-cell-size, 36px) * 8 + var(--kendo-infinite-calendar-view-padding-x, var(--kendo-spacing-3)) * 2)"</li></ul></td>
</tr>
<tr>
