...
slug: variables_kendothemefluent_picker
position: 9
---
...
<tr>
    <td colspan="4" class="theme-variables-description-container"><div><b>Description</b><div class="theme-variables-description">The default fill mode of the Picker.</div></div>
    </td>
</tr>
<tr>
...
<tr>
    <td colspan="4" class="theme-variables-description-container"><div><b>Description</b><div class="theme-variables-description">The default roundness of the Picker.</div></div>
    </td>
</tr>
<tr>
...
<tr>
    <td colspan="4" class="theme-variables-description-container"><div><b>Description</b><div class="theme-variables-description">The default size of the Picker.</div></div>
    </td>
</tr>
<tr>
    ...
    <td><code>var(--kendo-picker-text, var(--kendo-color-on-app-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-picker-bg, var(--kendo-color-surface-alt))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-picker-border, color-mix(in srgb, var(--kendo-color-border) 26%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-picker-outline-text, var(--kendo-color-on-app-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-picker-outline-bg, transparent )</code></td>
    <td><code>var(--kendo-picker-outline-bg, transparent)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-picker-outline-border, color-mix(in srgb, var(--kendo-color-border) 26%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-picker-flat-text, var(--kendo-color-on-app-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-picker-flat-border, var(--kendo-color-border))</code></td>
</tr>
<tr>
