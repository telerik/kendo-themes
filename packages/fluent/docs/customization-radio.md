...
<tr>
    ...
    <td><code>(sm: (size: 1rem, glyph-size: 0.875rem, indicator-size: 0.5rem, ripple-size: 300%), md: (size: 1.25rem, glyph-size: 1.125rem, indicator-size: 0.625rem, ripple-size: 300%), lg: (size: 1.5rem, glyph-size: 1.375rem, indicator-size: 0.75rem, ripple-size: 300%))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 14 14'%3e%3ccircle cx='50%25' cy='50%25' r='4' fill='var%28--kendo-primary-100, inherit%29'/%3e%3c/svg%3e")</code></td>
</tr>
<tr>
