...
<tbody>
    ...
    <td><code>var(--kendo-drawer-bg, var(--kendo-color-secondary-subtle))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-border, color-mix(in srgb, var(--kendo-color-border) 26%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-items-padding-x, var(--kendo-spacing-2\.5))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-items-padding-y, var(--kendo-spacing-2\.5))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-items-gap, var(--kendo-spacing-0\.5))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-padding-x, var(--kendo-spacing-4))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-padding-y, var(--kendo-spacing-2))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-spacing, var(--kendo-drawer-item-padding-x, var(--kendo-spacing-4)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-font-size, var(--kendo-font-size))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-drawer-item-line-height, var(--kendo-line-height-lg) )</code></td>
    <td><code>var(--kendo-drawer-item-line-height, var(--kendo-line-height-lg))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-drawer-item-font-weight, var(--kendo-font-weight) )</code></td>
    <td><code>var(--kendo-drawer-item-font-weight, var(--kendo-font-weight))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-level-padding-x, var(--kendo-spacing-4))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-border-radius, var(--kendo-border-radius-md))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-icon-padding-x, var(--kendo-spacing-0))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-icon-padding-y, var(--kendo-spacing-1))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-ripple-border-width, var(--kendo-spacing-1))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-ripple-border-height, var(--kendo-spacing-5))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-ripple-border-radius, var(--kendo-border-radius-md))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-ripple-spacing-x, var(--kendo-spacing-0\.5))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-ripple-border, var(--kendo-color-primary-on-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-bg, var(--kendo-drawer-bg, var(--kendo-color-secondary-subtle)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-text, var(--kendo-drawer-text, var(--kendo-color-on-app-surface)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-icon-text, var(--kendo-drawer-text, var(--kendo-color-on-app-surface)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-hover-bg, var(--kendo-color-surface-alt))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-hover-text, var(--kendo-drawer-item-text, var(--kendo-drawer-text, var(--kendo-color-on-app-surface))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-hover-icon-text, var(--kendo-drawer-icon-text, var(--kendo-drawer-text, var(--kendo-color-on-app-surface))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-focus-bg, var(--kendo-drawer-item-bg, var(--kendo-drawer-bg, var(--kendo-color-secondary-subtle))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-focus-text, var(--kendo-drawer-item-text, var(--kendo-drawer-text, var(--kendo-color-on-app-surface))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-focus-shadow, inset 0 0 0 2px var(--kendo-color-border-alt))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-focus-icon-text, var(--kendo-drawer-icon-text, var(--kendo-drawer-text, var(--kendo-color-on-app-surface))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-drawer-item-selected-font-weight, var(--kendo-font-weight-semibold) )</code></td>
    <td><code>var(--kendo-drawer-item-selected-font-weight, var(--kendo-font-weight-semibold))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-selected-bg, var(--kendo-drawer-item-bg, var(--kendo-drawer-bg, var(--kendo-color-secondary-subtle))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-selected-text, var(--kendo-drawer-item-text, var(--kendo-drawer-text, var(--kendo-color-on-app-surface))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-selected-icon-text, var(--kendo-color-primary-on-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-selected-hover-bg, var(--kendo-color-surface-alt))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-drawer-item-selected-hover-text, var(--kendo-drawer-item-text, var(--kendo-drawer-text, var(--kendo-color-on-app-surface))))</code></td>
</tr>
<tr>
