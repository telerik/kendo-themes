...
<tr>
    ...
    <td><code>calc(calc(var(--kendo-line-height, normal) * 1em + 0.25rem * 2 + 1px * 2) + 6px)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-primary-20, inherit)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-primary-30, inherit)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>calc(0.75rem - (calc(var(--kendo-line-height, normal) * 1em + 0.375rem * 2 + 1px * 2) - calc(1.4285714286 * 1em)) / 2)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-neutral-40, inherit)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>calc(calc(var(--kendo-line-height, normal) * 1em + 0.375rem * 2 + 1px * 2) + var(--kendo-icon-spacing, 0.5rem))</code></td>
</tr>
<tr>
