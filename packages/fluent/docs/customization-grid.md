...
<tr>
    ...
    <td><code>var(--kendo-grid-hover-border, var(--kendo-table-hover-border, var(--kendo-table-border, color-mix(in srgb, var(--kendo-color-border) 16%, transparent))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-grid-selected-border, var(--kendo-table-selected-border, var(--kendo-table-border, color-mix(in srgb, var(--kendo-color-border) 16%, transparent))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-grid-header-font-weight, var(--kendo-font-weight-normal) )</code></td>
    <td><code>var(--kendo-grid-header-font-weight, var(--kendo-font-weight-normal))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-grid-add-row-bg, #{$kendo-table-header-bg} )</code></td>
    <td><code>var(--kendo-grid-add-row-bg, var(--kendo-table-header-bg, var(--kendo-table-bg, var(--kendo-color-surface-alt))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-grid-add-row-text, #{$kendo-table-header-text} )</code></td>
    <td><code>var(--kendo-grid-add-row-text, var(--kendo-table-header-text, var(--kendo-color-on-app-surface)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-grid-add-row-border, #{$kendo-table-header-border} )</code></td>
    <td><code>var(--kendo-grid-add-row-border, var(--kendo-table-header-border, var(--kendo-table-border, color-mix(in srgb, var(--kendo-color-border) 16%, transparent))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-grid-grouping-row-border, var(--kendo-table-group-row-border, var(--kendo-table-header-border, var(--kendo-table-border, color-mix(in srgb, var(--kendo-color-border) 16%, transparent)))))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-grid-sort-indicator-order-text, var(--kendo-color-primary))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-grid-group-drop-hint-bg, var(--kendo-color-primary))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-filter-menu-container-padding-y, var(--kendo-spacing-3))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-filter-menu-container-padding-x, var(--kendo-spacing-3))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-grid-column-menu-spacing, var(--kendo-spacing-2))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-grid-column-menu-bg, var(--kendo-color-surface-alt))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-grid-column-menu-text, var(--kendo-color-on-app-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-grid-column-menu-border, color-mix(in srgb, var(--kendo-color-border) 16%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-grid-column-menu-multicheck-font-size, var(--kendo-list-md-font-size, var(--kendo-font-size)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-grid-column-menu-multicheck-line-height, var(--kendo-list-md-line-height, var(--kendo-line-height)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-grid-column-menu-item-gap, var(--kendo-list-md-item-padding-x, var(--kendo-spacing-1\.5)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-grid-column-menu-item-bg, var(--kendo-list-item-bg, var(--kendo-color-surface-alt)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-grid-column-menu-item-text, var(--kendo-list-item-text, var(--kendo-color-on-app-surface)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-grid-column-menu-item-icon-text, var(--kendo-list-item-icon-text, var(--kendo-color-primary)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><ul><li>sm: "header-padding-x":"var(--kendo-spacing-3)","header-padding-y":"var(--kendo-spacing-1\\.5)","grouping-header-padding-x":"var(--kendo-spacing-1\\.5)","grouping-header-padding-y":"var(--kendo-spacing-1\\.5)","cell-padding-x":"var(--kendo-spacing-3)","cell-padding-y":"var(--kendo-spacing-1\\.5)","filter-cell-padding-x":"var(--kendo-spacing-3)","filter-cell-padding-y":"var(--kendo-spacing-2)","edit-cell-padding-x":"var(--kendo-spacing-3)","edit-cell-padding-y":"var(--kendo-spacing-0\\.5)","button-padding-y":"calc(var(--kendo-button-sm-padding-y, var(--kendo-spacing-0\\.5)) + 1px)","button-calc-size":"calc(var(--kendo-line-height-lg) * 1em + calc(var(--kendo-button-sm-padding-y, var(--kendo-spacing-0\\.5)) + 1px) * 2 + var(--kendo-button-border-width, 1px) * 2)","group-dropclue-height":"calc(calc(var(--kendo-line-height-lg) * 1em + calc(var(--kendo-spacing-0\\.5) / 2) * 2 + var(--kendo-chip-border-width, 1px) * 2) + var(--kendo-grid-group-drop-hint-size, 6px))","selection-aggregates-padding-x":"var(--kendo-spacing-1\\.5)","selection-aggregates-padding-y":"var(--kendo-spacing-1\\.5)"</li><li>md: "header-padding-x":"var(--kendo-table-md-cell-padding-x, var(--kendo-spacing-2))","header-padding-y":"var(--kendo-table-md-cell-padding-y, var(--kendo-spacing-2\\.5))","grouping-header-padding-x":"calc(var(--kendo-toolbar-md-padding-x, var(--kendo-spacing-3)) + 1px)","grouping-header-padding-y":"calc(var(--kendo-toolbar-md-padding-y, var(--kendo-spacing-1\\.5)) + 1px)","cell-padding-x":"var(--kendo-table-md-cell-padding-x, var(--kendo-spacing-2))","cell-padding-y":"var(--kendo-table-md-cell-padding-y, var(--kendo-spacing-2\\.5))","filter-cell-padding-x":"var(--kendo-table-md-cell-padding-y, var(--kendo-spacing-2\\.5))","filter-cell-padding-y":"var(--kendo-table-md-cell-padding-y, var(--kendo-spacing-2\\.5))","edit-cell-padding-x":"var(--kendo-table-md-cell-padding-x, var(--kendo-spacing-2))","edit-cell-padding-y":"calc(var(--kendo-spacing-2\\.5) / 2)","button-padding-y":"calc(var(--kendo-button-md-padding-y, var(--kendo-spacing-1)) + 1px)","button-calc-size":"calc(var(--kendo-line-height) * 1em + calc(var(--kendo-button-md-padding-y, var(--kendo-spacing-1)) + 1px) * 2 + var(--kendo-button-border-width, 1px) * 2)","group-dropclue-height":"var(--kendo-grid-group-drop-hint-height, calc(calc(var(--kendo-chip-line-height, var(--kendo-line-height-lg)) * 1em + calc(var(--kendo-chip-padding-y, var(--kendo-spacing-1\\.5)) / 2) * 2 + var(--kendo-chip-border-width, 1px) * 2) + var(--kendo-grid-group-drop-hint-size, 6px)))","selection-aggregates-padding-x":"var(--kendo-spacing-2)","selection-aggregates-padding-y":"var(--kendo-spacing-2)"</li></ul></td>
</tr>
<tr>
