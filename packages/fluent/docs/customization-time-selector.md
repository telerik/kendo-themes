...
<tr>
    ...
    <td><code>calc(0.75rem + var(--kendo-font-size-xs, inherit) * var(--kendo-line-height-lg, inherit))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>calc(var(--kendo-font-size, inherit) * var(--kendo-line-height, normal) + 0.5rem)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>(sm: (font-size: var(--kendo-font-size, inherit), line-height: var(--kendo-line-height, normal), list-item-padding-x: 0.5rem, list-item-padding-y: 0.375rem), md: (font-size: var(--kendo-font-size, inherit), line-height: var(--kendo-line-height, normal), list-item-padding-x: 0.5rem, list-item-padding-y: 0.5rem), lg: (font-size: var(--kendo-font-size, inherit), line-height: var(--kendo-line-height, normal), list-item-padding-x: 0.5rem, list-item-padding-y: 0.625rem))</code></td>
</tr>
<tr>
