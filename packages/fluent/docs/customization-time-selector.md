...
<tr>
    ...
    <td><code>var(--kendo-time-selector-text, var(--kendo-color-on-app-surface, #323130))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-time-selector-border, color-mix(in srgb, var(--kendo-color-border, #8a8886) 16%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-time-selector-header-title-text, unset )</code></td>
    <td><code>var(--kendo-time-selector-header-title-text, unset)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-time-selector-header-time-now-text, k-color(primary) )</code></td>
    <td><code>var(--kendo-time-selector-header-time-now-text, var(--kendo-color-primary, #0078d4))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-time-selector-header-time-now-hover-text, k-color(primary-hover) )</code></td>
    <td><code>var(--kendo-time-selector-header-time-now-hover-text, var(--kendo-color-primary-hover, #106ebe))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-time-list-title-spacing, k-spacing(3) )</code></td>
    <td><code>var(--kendo-time-list-title-spacing, var(--kendo-spacing-3, 0.75rem))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-time-list-title-line-height, var( --kendo-line-height-lg, inherit ) )</code></td>
    <td><code>var(--kendo-time-list-title-line-height, var(--kendo-line-height-lg, inherit))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-time-list-title-text, var(--kendo-color-subtle, #605e5c))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-time-list-title-focus-text, var(--kendo-time-selector-text, var(--kendo-color-on-app-surface, #323130)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-time-list-item-padding-x, k-spacing(2) )</code></td>
    <td><code>var(--kendo-time-list-item-padding-x, var(--kendo-spacing-2, 0.5rem))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-time-list-highlight-bg, $kendo-time-selector-bg )</code></td>
    <td><code>var(--kendo-time-list-highlight-bg, var(--kendo-time-selector-bg, var(--kendo-color-surface-alt, #ffffff)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-time-list-highlight-border, $kendo-time-selector-border )</code></td>
    <td><code>var(--kendo-time-list-highlight-border, var(--kendo-time-selector-border, color-mix(in srgb, var(--kendo-color-border, #8a8886) 16%, transparent)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-time-list-focus-bg, rgba(0, 0, 0, .04) )</code></td>
    <td><code>var(--kendo-time-list-focus-bg, rgba(0, 0, 0, 0.04))</code></td>
</tr>
<tr>
