...
<tr>
    ...
    <td><code>var(--kendo-treeview-gap, var(--kendo-spacing-0\.5))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-border-radius, var(--kendo-border-radius-md))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-treeview-font-family, var(--kendo-font-family) )</code></td>
    <td><code>var(--kendo-treeview-font-family, var(--kendo-font-family))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-treeview-sm-font-size, var(--kendo-font-size-sm) )</code></td>
    <td><code>var(--kendo-treeview-sm-font-size, var(--kendo-font-size-sm))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-treeview-md-font-size, var(--kendo-font-size) )</code></td>
    <td><code>var(--kendo-treeview-md-font-size, var(--kendo-font-size))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-treeview-lg-font-size, var(--kendo-font-size-lg) )</code></td>
    <td><code>var(--kendo-treeview-lg-font-size, var(--kendo-font-size-lg))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-treeview-sm-line-height, var(--kendo-line-height-lg) )</code></td>
    <td><code>var(--kendo-treeview-sm-line-height, var(--kendo-line-height-lg))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-treeview-md-line-height, var(--kendo-line-height) )</code></td>
    <td><code>var(--kendo-treeview-md-line-height, var(--kendo-line-height))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td>String</td>
    <td><code>var( --kendo-treeview-lg-line-height, var(--kendo-line-height-sm) )</code></td>
    <td><code>var(--kendo-treeview-lg-line-height, var(--kendo-line-height-sm))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-indent, var(--kendo-spacing-6))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-sm-item-padding-x, var(--kendo-spacing-2))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-md-item-padding-x, var(--kendo-spacing-2))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-lg-item-padding-x, var(--kendo-spacing-3\.5))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-sm-item-padding-y, var(--kendo-spacing-1\.5))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-md-item-padding-y, var(--kendo-spacing-1\.5))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-lg-item-padding-y, var(--kendo-spacing-2))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-item-border-radius, var(--kendo-border-radius-md))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-filter-padding-x, var(--kendo-spacing-2))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-filter-padding-y, var(--kendo-spacing-2))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-text, var(--kendo-color-on-app-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-item-text, var(--kendo-color-on-app-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-item-hover-bg, color-mix(in srgb, var(--kendo-color-on-app-surface) 5%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-item-hover-text, var(--kendo-color-on-app-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-item-focus-shadow, inset 0 0 0 2px var(--kendo-color-on-app-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-item-selected-bg, color-mix(in srgb, var(--kendo-color-on-app-surface) 13%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-item-selected-text, var(--kendo-color-on-app-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-item-selected-hover-bg, var(--kendo-color-base-emphasis))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-item-disabled-text, color-mix(in srgb, var(--kendo-color-on-app-surface) 30%, transparent))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-loadmore-text, var(--kendo-color-primary-on-surface))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>var(--kendo-treeview-loadmore-focus-shadow, var(--kendo-treeview-item-focus-shadow, inset 0 0 0 2px var(--kendo-color-on-app-surface)))</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><ul><li>sm: "font-size":"var(--kendo-treeview-sm-font-size, var(--kendo-font-size-sm))","line-height":"var(--kendo-treeview-sm-line-height, var(--kendo-line-height-lg))","item-padding-x":"var(--kendo-treeview-sm-item-padding-x, var(--kendo-spacing-2))","item-padding-y":"var(--kendo-treeview-sm-item-padding-y, var(--kendo-spacing-1\\.5))","checkbox-padding-x":"var(--kendo-spacing-1)","checkbox-padding-y":"var(--kendo-spacing-1)"</li><li>md: "font-size":"var(--kendo-treeview-md-font-size, var(--kendo-font-size))","line-height":"var(--kendo-treeview-md-line-height, var(--kendo-line-height))","item-padding-x":"var(--kendo-treeview-md-item-padding-x, var(--kendo-spacing-2))","item-padding-y":"var(--kendo-treeview-md-item-padding-y, var(--kendo-spacing-1\\.5))","checkbox-padding-x":"var(--kendo-spacing-1\\.5)","checkbox-padding-y":"var(--kendo-spacing-1\\.5)"</li><li>lg: "font-size":"var(--kendo-treeview-lg-font-size, var(--kendo-font-size-lg))","line-height":"var(--kendo-treeview-lg-line-height, var(--kendo-line-height-sm))","item-padding-x":"var(--kendo-treeview-lg-item-padding-x, var(--kendo-spacing-3\\.5))","item-padding-y":"var(--kendo-treeview-lg-item-padding-y, var(--kendo-spacing-2))","checkbox-padding-x":"var(--kendo-spacing-2)","checkbox-padding-y":"var(--kendo-spacing-2)"</li></ul></td>
</tr>
<tr>
