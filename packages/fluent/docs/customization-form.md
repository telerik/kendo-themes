...
<tr>
    ...
    <td><code>calc(100% - 25% - 0.5rem)</code></td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>(sm: (form-rows-spacing: 0.75rem), md: (form-rows-spacing: 0.75rem), lg: (form-rows-spacing: 0.75rem))</code></td>
</tr>
<tr>
