...
<tr>
    ...
    <td><ul><li>base: var(--kendo-color-base, #ebebeb)</li><li>error: var(--kendo-color-error-subtle, #f4c3b8)</li><li>info: var(--kendo-color-info-subtle, #cce5f3)</li><li>warning: var(--kendo-color-warning-subtle, #ffdead)</li><li>success: var(--kendo-color-success-subtle, #bbdfc1)</li></ul></td>
</tr>
<tr>
