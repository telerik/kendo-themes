...
<tr>
    ...
    <td>List</td>
    <td><code>0 0 4px 0 color-mix(in srgb, k-color(primary) 75%, transparent)</code></td>
    <td><code>(0 0 4px 0 color-mix(in srgb, var(--kendo-color-primary) 75%, transparent))</code></td>
</tr>
<tr>
