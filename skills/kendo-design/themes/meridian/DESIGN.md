...
- **Body** (`body-xs` through `body-md`) — Normal weight (400) with generous line height: `body-md` for primary body text, `body-sm` for secondary text and descriptions, `body-xs` for captions and footnotes.
...
- **Transition** (`prompt`, `timely`, `moderate`, `measured`) — Overlay transitions, deliberate reveals, full-screen and layout transitions.
- **Ambient** (`steady`, `leisurely`, `slow`, `languid`, `sluggish`) — Large panel motion, expansive transitions, background and ambient animation.
...
The official Meridian UI kit for Figma: [Telerik & Kendo UI Kit for Meridian 1.0](https://www.figma.com/community/file/1661068732333132440/telerik-kendo-ui-kit-for-meridian-1-0).
