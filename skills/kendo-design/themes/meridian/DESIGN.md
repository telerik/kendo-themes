...
name: Kendo Meridian
theme: meridian
description: The Kendo Meridian theme — the recommended default design language (v14.0.0+). A modern, balanced visual identity for data-rich professional interfaces, built on perceptually uniform oklch color space.
colors:
