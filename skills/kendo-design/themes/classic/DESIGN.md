...
colors:
  ...
  on-app-surface: "oklch(27% 0 0deg)"
  subtle: "oklch(51.03% 0 0deg)"
  surface: "oklch(95.51% 0 0deg)"
  surface-alt: "oklch(100.01% 0 0deg)"
...
typography:
  font-family:
    ...
    mono: SFMono-Regular, Menlo, Monaco, Consolas, "Roboto Mono", "Ubuntu Mono", "Lucida Console", "Courier New", monospace
  font-size: { xs: 0.625rem, sm: 0.75rem, md: 0.875rem, lg: 1rem, xl: 1.25rem }
  font-weight: { regular: 400, medium: 500, semibold: 600 }
  line-height: { tight: 1.25, normal: 1.4286 }
  letter-spacing:
    base: null
    tightest: -0.15px
    tighter: -0.10px
