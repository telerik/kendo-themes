...
|  | `aria-valuemin` | Optional. Set to a decimal value representing the minimum value, and less than "aria-valuemax". If not present, the default value is 0. |
|  | `aria-valuemax` | Optional. Set to a decimal value representing the maximum value, and greater than "aria-valuemin". If not present, the default value is 100. |
