...
| `.k-colorgradient-slider[data-gradient-type="2d"] .k-draghandle` | `aria-orientation=undefined` | For 2D gradient sliders in color pickers, direction cannot be determined. The string value "undefined" is used. |
