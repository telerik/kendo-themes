...
- **Node.js** - Required runtime (exact version specified in package.json)
- **Lerna + Nx** - Monorepo management and task running
...
integrations/          # Webpack/Vite/ESBuild/Parcel/Vite/Gulp scss compilation tests
```
...
Document ALL SCSS variables using SassDoc triple-slash comments:
...
- Start descriptions with "The [property] of the [Component]."
- Use `@group component-name` (lowercase, hyphenated, singular)
- Include sub-element names: "The padding of the Button header."
- Include state information: "The background color of the hovered Button."
