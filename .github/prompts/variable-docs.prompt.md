---
mode: "agent"
tools: ["codebase", "editFiles", "semantic_search"]
...
- **Direct editing only**: Do not provide examples in chat. Do not argument about the changes in chat. Do not provide summary. Only edit files directly.
