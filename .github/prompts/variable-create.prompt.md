...
### Triple-Slash Comment Format

```scss
/// The [property] of the [Component][ Sub-element][ State].
...
1. **Start with "The"**: Every description begins with "The"
2. **Include component name**: Always mention the component being styled
3. **Specify sub-elements**: Include sub-element names when applicable
4. **Indicate states**: Mention states for state-specific variables
5. **End with period**: All descriptions end with a period
6. **Group annotation**: Always include `@group component-name` (lowercase, hyphenated)
...
/// @group button
$kendo-button-bg: k-color(primary) !default;

/// The horizontal padding of the small Button.
/// @group button
$kendo-button-sm-padding-x: k-spacing(2) !default;

/// The border color of the focused Input.
/// @group input
$kendo-input-focus-border: k-color(primary) !default;

/// The background color of the selected Grid row.
/// @group grid
$kendo-grid-row-selected-bg: k-color(primary-subtle) !default;
```
