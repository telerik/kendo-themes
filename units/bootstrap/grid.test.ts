...
const unexpected = [
    ...
    "kendo-grid-header-padding-y", // This variable is only used in the Gantt component.
    "kendo-grid-grouping-row-bg", // Variable is not used because Bootstrap _theme file does not consume core styles.
    "kendo-grid-grouping-row-text", // Variable is not used because Bootstrap _theme file does not consume core styles.
];
